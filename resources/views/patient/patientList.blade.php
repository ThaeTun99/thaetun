    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="relative overflow-x-auto">
            ...
            <a href="/patient/create">
                <button class="bg-blue-800 rounded-lg px-8 py-1 text-white mb-5 ml-3 float-right">
                ...
                <tbody>
                    @forelse ($patients as $patient)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-4">
                                <a href="/patient/{{ $patient->id }}" class="underline text-blue-800 font-bold">
                                    {{ $patient->p_name }}
                                </a>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-center">
                                <form action="/patient/{{ $patient->id }}" method="post">
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" class="ml-4 text-red-700 underline font-bold">
                                        {{ __('hospital.delete') }}
                                    </button>
                                </form>
                            </td>
