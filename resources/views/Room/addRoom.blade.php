...
<body>
    <div class="m-10">
        <h1 class="text-xl underline decoration-green-500 mb-4">{{ __('room.title') }}</h1>
        <form action="/room" method="POST"  enctype="multipart/form-data">
            ...
            <a href="/home"
                class="text-white py-3 px-6 bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                {{ __('hospital.Back') }}
            </a>
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 ml-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                {{ __('room.Add') }}
            </button>
