...
<body class="flex justify-center items-center bg-gray-900 h-screen">
    ...
    <div class="box relative bg-gray-600 p-10 w-1/2 rounded-lg border-gray-900 border-4">
        ...
        <form action="/login" method="post">
            @csrf
            {{-- <h1 class="text-center font-semibold text-xl text-white pb-10">Login</h1> --}}
            <h1 class="text-white text-xl font-semibold text-center pb-10"> {{ __("hospital.login")}}</h1>
            <div class="mb-6">
                <label for="username" class="block mb-2 text-sm font-bold text-white dark:text-white">
                    {{ __("hospital.username")}}
                </label>
            ...
            <div class="mb-6">
                <label for="password" class="block mb-2 text-sm font-bold text-white dark:text-white">
                    {{ __("hospital.password")}}
                </label>
